...
if(s.length>0)for(let i=0;i<s.length;i++){s[i].style.paddingRight=e}o.style.paddingRight=e,o.classList.add("lock"),n=!1,setTimeout((function(){n=!0}),800)}(),e.classList.add("open"),e.addEventListener("click",(function(e){e.target.closest(".popup__content")||a(e.target.closest(".popup"))}))}}function a(e,i=!0){n&&(e.classList.remove("open"),i&&(setTimeout((function(){if(s.length>0)for(let e=0;e<s.length;e++)s[e].style.paddingRight="0px";o.style.paddingRight="0px",o.classList.remove("lock")}),800),n=!1,setTimeout((function(){n=!0}),800)))}document.addEventListener("keydown",(function(e){if(27===e.which){a(document.querySelector(".popup.open"))}})),Element.prototype.closest||(Element.prototype.closest=function(e){for(var i=this;i;){if(i.matches(e))return i;i=i.parentElement}return null}),Element.prototype.matches||(Element.prototype.matches=Element.prototype.matchesSelector||Element.prototype.webkitMatchesSelector||Element.prototype.mozMatchesSelector||Element.prototype.msMatchesSelector),$(".tabs-triggers__item").click((function(e){e.preventDefault();var i=$(this).closest(".tabs").attr("id");$("#"+i+" .tabs-triggers__item").removeClass("tabs-triggers__item--active"),$("#"+i+" .tabs-content__item").removeClass("tabs-content__item--active"),$(this).addClass("tabs-triggers__item--active"),$($(this).attr("href")).addClass("tabs-content__item--active")}));let d=document.querySelectorAll(".tabs");if(d.length>0)for(let e=0;e<d.length;e++){const i=d[e];let t=$(i).attr("id");$("#"+t+" .tabs-triggers__item:first").click()}$(".login").click((function(e){$("#authTabs .tabs-triggers__item:first").click()})),$(".sign-up").click((function(e){$("#authTabs .tabs-triggers__item:last").click()}))}));