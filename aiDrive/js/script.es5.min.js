...
if(s.length>0)for(var i=0;i<s.length;i++){s[i].style.paddingRight=e}o.style.paddingRight=e,o.classList.add("lock"),n=!1,setTimeout((function(){n=!0}),800)}(),e.classList.add("open"),e.addEventListener("click",(function(e){e.target.closest(".popup__content")||p(e.target.closest(".popup"))}))}}(document.getElementById(t)),e.preventDefault()}))},l=0;l<t.length;l++)r(l);var a=document.querySelectorAll(".close-popup");if(a.length>0)for(var d=function(e){var i=a[e];i.addEventListener("click",(function(e){p(i.closest(".popup")),e.preventDefault()}))},c=0;c<a.length;c++)d(c);function p(e){var i=!(arguments.length>1&&void 0!==arguments[1])||arguments[1];n&&(e.classList.remove("open"),i&&u())}function u(){setTimeout((function(){if(s.length>0)for(var e=0;e<s.length;e++){s[e].style.paddingRight="0px"}o.style.paddingRight="0px",o.classList.remove("lock")}),800),n=!1,setTimeout((function(){n=!0}),800)}document.addEventListener("keydown",(function(e){27===e.which&&p(document.querySelector(".popup.open"))})),Element.prototype.closest||(Element.prototype.closest=function(e){for(var i=this;i;){if(i.matches(e))return i;i=i.parentElement}return null}),Element.prototype.matches||(Element.prototype.matches=Element.prototype.matchesSelector||Element.prototype.webkitMatchesSelector||Element.prototype.mozMatchesSelector||Element.prototype.msMatchesSelector),$(".tabs-triggers__item").click((function(e){e.preventDefault();var i=$(this).closest(".tabs").attr("id");$("#"+i+" .tabs-triggers__item").removeClass("tabs-triggers__item--active"),$("#"+i+" .tabs-content__item").removeClass("tabs-content__item--active"),$(this).addClass("tabs-triggers__item--active"),$($(this).attr("href")).addClass("tabs-content__item--active")}));var h=document.querySelectorAll(".tabs");if(h.length>0)for(var f=0;f<h.length;f++){var v=h[f],k=$(v).attr("id");$("#"+k+" .tabs-triggers__item:first").click()}$(".login").click((function(e){$("#authTabs .tabs-triggers__item:first").click()})),$(".sign-up").click((function(e){$("#authTabs .tabs-triggers__item:last").click()}))}));